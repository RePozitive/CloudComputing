...
proc do 
  ...
  Caller.new("Denis", ate).call("3434")
  Caller.new("Roman", ate).call("2345")
  Caller.new("Ilya",  ate).call("3434")
  Caller.new("Sasha", ate).call("3434")
  Caller.new("Lera",  ate).call("2345")
  Caller.new("Kira",  ate).call("2345")
  Caller.new("Ivan",  ate).call("3434")
end.()
